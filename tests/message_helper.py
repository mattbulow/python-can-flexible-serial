"""
Helper for writing test cases that need to compare messages.

Ported from python-can's ``test/message_helper.py``
(https://github.com/hardbyte/python-can/blob/main/test/message_helper.py).
"""
